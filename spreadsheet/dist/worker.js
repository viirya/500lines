      ...
      try {
        ...
        try {
          ...
          try {
            ...
            calc = function(event) {
              var $__4;
              ($__4 = [{}, {}, event.data], cache = $__4[$traceurRuntime.toProperty(0)], errs = $__4[$traceurRuntime.toProperty(1)], sheet = $__4[$traceurRuntime.toProperty(2)], $__4);
                              ...
                              Object.defineProperty(self, pre + cr, {get: (function() {
                                  ...
                                  try {
                                    ...
                                    try {
                                      ...
                                      if (match && !($traceurRuntime.toProperty(match[$traceurRuntime.toProperty(0)]) in self)) {
                                        $traceurRuntime.setProperty(self, match[$traceurRuntime.toProperty(0)], 0);
